                ...
                <div className="rounded-lg bg-white shadow-xs overflow-hidden">
                    ...
                    <div className="px-5 pt-4 flex items-center justify-between">
                        ...
                        <div className="-mr-2">
                            ...
                            <button type="button" className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out" onClick={() => console.log('fired')}>
